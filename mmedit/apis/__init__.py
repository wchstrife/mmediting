...
from .matting_inference import init_model, matting_inference, matting_inference_file, fba_inference, indexfg_inference
...
__all__ = [
    ...
    'generation_inference', 'multi_gpu_test', 'single_gpu_test', 'fba_inference', 'indexfg_inference'
]
