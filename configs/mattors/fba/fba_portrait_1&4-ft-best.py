# model
# 在29最优的模型上，在Adobe+Dist646 数据集上finetune
# 6卡训练
# 
model = dict(
    type='FBA',
...
lr_config = dict(policy='Step', step=[64000 * 8], gamma=0.1, by_epoch=False)   # 共64000
...
# runtime settings
total_iters = 64000*16
dist_params = dict(backend='nccl')
log_level = 'INFO'
work_dir = './work_dirs/fba/train'
load_from = 'work_dirs/fba/mx-gn1-gpu6/iter_1080000.pth'     # best model
resume_from = None
workflow = [('train', 1)]
