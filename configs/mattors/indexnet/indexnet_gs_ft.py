...
evaluation = dict(interval=3000, save_image=False)
# yapf:disable
log_config = dict(
    interval=10,
    hooks=[
...
log_level = 'INFO'
work_dir = './work_dirs/indexnet/gs'
load_from = './work_dirs/indexnet/gs/indexnet_mobv2_1x16_78k_comp1k_SAD-45.6_20200618_173817-26dd258d.pth'
resume_from = None
workflow = [('train', 1)]
